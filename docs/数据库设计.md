...
| industry_category | VARCHAR(50) | 行业分类（影响抽成基准） |
...
| admin_decision_option / admin_decision_remark | VARCHAR / TEXT | 平台裁决方案与备注 |
