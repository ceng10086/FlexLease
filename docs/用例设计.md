...
| UC-U14 | 个人资料与信用档案管理 | 填写联系方式、查看信用档位/冻结状态 | `pages/customer/ProfilePage.vue` |
...
- **UC-U14 个人资料与信用档案**
  - 首次进入 `ProfilePage` 会调用 `/customers/profile` 自动建档，并拉取 `creditScore/creditTier/suspendedUntil` 等字段。
