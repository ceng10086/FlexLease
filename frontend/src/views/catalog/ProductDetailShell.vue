      ...
      <PageSection title="方案选择">
        ...
        <div class="plan-stats">
          <div class="stat-card">
            ...
            <div class="stat-card__value">¥{{ selectedPlan?.rentAmountMonthly.toFixed(2) ?? '--' }}</div>
          </div>
          <div class="stat-card">
            <div class="stat-card__label">押金</div>
            <div class="stat-card__value">¥{{ selectedPlan?.depositAmount.toFixed(2) ?? '--' }}</div>
          </div>
          <div class="stat-card">
          ...
          <div class="stat-card">
            ...
            <div class="stat-card__value">
              {{ selectedPlan?.buyoutPrice ? `¥${selectedPlan.buyoutPrice.toFixed(2)}` : '支持业务审批' }}
            </div>
          </div>
        </div>
      </PageSection>
